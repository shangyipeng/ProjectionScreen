...
import com.example.myapplication.bean.PointBean;
...
public class onDraw extends View {
    ...
    public onDraw(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public onDraw(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void onActionUp(MotionEvent event){
        try {
            if(pointBean != null){
                ...
                DataUtile.lineToX=x1;
                DataUtile.lineToY=y1;
